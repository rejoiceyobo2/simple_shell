...
/**
 * hsh - Shell main function that runs the shell loop.
 ...
 * @info: Pointer to the info_t struct containing shell information.
 *
 * Return: Returns the exit status of the built-in command.
 */
...
/**
 * find_cmd - Searches for and executes a non-built-in command.
 * @info: Pointer to the info_t struct containing shell information.
 */
